...
export class PanneService {
  apiUrl ='http://localhost:8080/api/panne/';
  httpOptions = {
  ...
  public update(ci: any): Observable<any> {
    return this.httpClient.put<any>(this.apiUrl + 'updatePanne', ci, this.httpOptions);
  }
  ...
  public planMM(id:number): Observable<any> {
    return this.httpClient.get<any>(this.apiUrl + 'listPMP/'+id, this.httpOptions);
  }
}
